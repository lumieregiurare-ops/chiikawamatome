(() => {
  ...
  function applyPlaceholder(box, seed) {
    ...
    box.style.background = PASTELS[hashHue(seed) % PASTELS.length];
    box.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true" fill="#fff"><path d="M12 2l2.9 6.5L22 9.6l-5.2 4.8 1.4 7.6L12 18.1l-6.2 3.9 1.4-7.6L2 9.6l7.1-1.1z"/></svg>';
  }
